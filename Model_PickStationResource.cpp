...
Model_PickStationResource::Model_PickStationResource() {
}
 ...
 */
int Model_PickStationResource::main(int argc, char** argv) {
	...
	//
	model->save("./models/Model_PickStationResource.txt");
